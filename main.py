...
attn_mode = "s+t"
dataset_name = "CHBMIT_1s_0.75OW" # "bonn_256", "IIT_Delhi_128"
...
if dataset_name == "CHBMIT_1s_0.75OW":
    ...
    img_size = (1,256)
    attn_values_residual = True
    attn_values_residual_conv_kernel = 9
    attn_dropout = 0.2
    ff_dropout = 0.3
    num_heads = 4
    depth = 3
    ...
    img_size = (1,128)
    attn_values_residual = True
    attn_values_residual_conv_kernel = 5
    attn_dropout = 0.1
    ff_dropout = 0.1
    num_heads = 4
    depth = 3
...
subj_results = {"val_accuracy": [], "val_hmean": [], "val_sensitivity": [], "val_specificity": [], "test_accuracy": [], "test_hmean": [], "test_sensitivity": [], "test_specificity": [], "best_epoch": []}
